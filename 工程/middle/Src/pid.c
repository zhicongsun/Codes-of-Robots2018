...
/*************  云台yaw  *********/
//随动yaw角度环
float P_6623_yaw_ang=3,I_6623_yaw_ang=0.2,D_6623_yaw_ang=3;
//随动yaw速度环
float P_yaw_spd=10,I_yaw_spd=0,D_yaw_spd=0;
//自动瞄准yaw角度环
float P_autu_6623_yaw_ang=12,I_autu_6623_yaw_ang=0,D_autu_6623_yaw_ang=0;
//非随动yaw角度环
//float P_6623_yaw_ang=10,I_6623_yaw_ang=0,D_6623_yaw_ang=0;


/*************  云台pitch  *********/
float P_6623_pit_spd=60,I_6623_pit_spd=0.5,D_6623_pit_spd=2.5;
float P_6623_pit_ang=0.25,I_6623_pit_ang=0.01,D_6623_pit_ang=0.02;
float autu_P_6623_pit_ang=8,autu_I_6623_pit_ang=0,autu_D_6623_pit_ang=0;

/*************  拨弹  *********/

float P_tog_ang = 0.1, 	I_tog_ang = 0,D_tog_ang = 0;
float P_tog_spd = 5, 		I_tog_spd = 0,D_tog_spd = 0;
