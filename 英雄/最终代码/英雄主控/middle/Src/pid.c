...
/*************  底盘运动  *********/
float P_3508_ang=0.6,I_3508_ang=0,D_3508_ang=10;
float P_3508_spd=5,I_3508_spd=0.0005,D_3508_spd=0.01;
float P_Follow=4,I_Follow=0,D_Follow=0.001;


/*************  云台yaw  *********/
//14	0.1		0		300		50
//50	1.22	4		4000	3000
//float P_6623_yaw_ang=14,I_6623_yaw_ang=0.1,D_6623_yaw_ang=0;
//float P_6623_yaw_spd=50,I_6623_yaw_spd=1.22,D_6623_yaw_spd=4;

float P_6623_yaw_ang=15,I_6623_yaw_ang=0.02,D_6623_yaw_ang=6;
float P_6623_yaw_spd=16,I_6623_yaw_spd=0.2,D_6623_yaw_spd=10;
...
//15	0			6		200		10
//50	1.2		3		5000	5000
float P_6623_pit_ang=20,I_6623_pit_ang=0.25,D_6623_pit_ang=55;
float P_6623_pit_spd=1.5,I_6623_pit_spd=0.005,D_6623_pit_spd=0;

float autu_P_6623_pit_ang=4,autu_I_6623_pit_ang=0,autu_D_6623_pit_ang=0;

/*************  拨弹  *********/

float P_tog_ang = 0.2, 	I_tog_ang = 0,D_tog_ang = 0.10;
float P_tog_spd = 5, 		I_tog_spd = 0.08,D_tog_spd = 0.1;
...
float pid_calc_pitch_angle(pid_t* pid, float get, float set)
{
    pid->get[NOW] = get;
    pid->set[NOW] = set;
    ...
    if(pid->pid_mode == POSITION_PID) //位置式p
    {
        ...
        pid->dout = pid->dout * 0.5 + (pid->d * (pid->err[NOW] - pid->err[LAST] )) * 0.5;
